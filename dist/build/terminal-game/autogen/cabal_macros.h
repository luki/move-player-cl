...
/* package terminal-game-0.1.0.0 */
#ifndef VERSION_terminal_game
#define VERSION_terminal_game "0.1.0.0"
#endif /* VERSION_terminal_game */
#ifndef MIN_VERSION_terminal_game
#define MIN_VERSION_terminal_game(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_terminal_game */
...
#define CURRENT_COMPONENT_ID "terminal-game-0.1.0.0-99jSBOIzwTx9cuXoQdqq0-terminal-game"
